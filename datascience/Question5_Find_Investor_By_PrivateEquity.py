...
df = df[(df.InvestorsName != 'Undisclosed Investor') & (df.InvestorsName != 'Undisclosed Investors') & (df.InvestorsName != 'Undisclosed investors') & (df.InvestmentType == 'Private Equity')]
